...
class CreatorProfile(models.Model):
    ...
    profile_image = models.ImageField(
        upload_to="creator_profiles/", blank=True, null=True
    )
    ...
    categories = models.ManyToManyField(
        CreatorCategory, blank=True, related_name="creators"
    )
    # Social media links
    x_profile = models.URLField(
        blank=True, validators=[URLValidator()], help_text="X (Twitter) profile URL"
    )
    instagram_profile = models.URLField(
        blank=True, validators=[URLValidator()], help_text="Instagram profile URL"
    )
    youtube_profile = models.URLField(
        blank=True, validators=[URLValidator()], help_text="YouTube channel URL"
    )
    tikTok_profile = models.URLField(
        blank=True, validators=[URLValidator()], help_text="TikTok profile URL"
    )
    facebook_profile = models.URLField(
        blank=True, validators=[URLValidator()], help_text="Facebook profile URL"
    )
