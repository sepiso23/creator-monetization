...
class RegistrationResponseSerializer(serializers.Serializer):
    ...
    Used to return newly created user access and refresh tokens upon
...
class SuccessResponseSerializer(serializers.Serializer):
    ...
    data = serializers.DictField(
        child=serializers.CharField(), allow_null=True, default=None
    )
...
class UnauthorizedErrorSerializer(ErrorSerializer):
    ...
    message = serializers.CharField(
        default="Client Authentication required or token invalid"
    )
